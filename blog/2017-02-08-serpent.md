...
![snake](http://i.imgsafe.org/c57c602990.jpg)
...
![Python](http://i.imgsafe.org/c402090113.jpg)
...
1 attoether = 10^(-18) ether

Usage: serpent_test <file> <function invocation>
"""
...
result       = blockchain.send(PRIVATE_KEY, address, ATTOETHER, call_data)
...
% serpent_test two_functions.se "add_thousand(0xea)"
...
Save the code above in a file called node_cmd and make it executable.
...
The call data can be obtained from the aforementioned serpent_test script.  Here is a slightly edited actual session on a Linux computer running an ETC Parity node:
...
![Steve Jobs](http://i.imgsafe.org/d2ca2d17d2.jpg)
