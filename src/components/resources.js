    ...
    <>
      ...
      <Grid>
        ...
        <Card title="Public APIs">
          Query ETC without syncing a node. Please note these are public nodes and are intended for
          testing and light use. Please run your own nodes for your programs. JSONRPC API references
          can be found for parity and geth-etc.
          <LinkGroup
            items={[
              {
