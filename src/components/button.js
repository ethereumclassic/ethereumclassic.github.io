  ...
  return (
    <Comp
      css={[
        ...
        tw`!no-underline !font-medium !text-shade-neutral px-4 py-2 text-sm inline-flex items-center mb-1 mr-1 border border-transparent shadow-sm leading-4 bg-backdrop-light rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 hover:bg-secondary-lightest`,
        primary &&
