      ...
      <WideSection full>
        <Grid>
          <Card className="green" to="https://originalmy.com/" title="OriginalMy">
            OriginalMy provides a fully automated platform to register and verify the authenticity
            of digital documents, contracts, and identities. They are now expanding into stock
            holder voting on the blockchain.
          </Card>
          ...
          <Card className="green" to="https:/www.portal.network/" title="Portal Network's BNS">
            Portal Network created the Blockchain Name Service standard that turns cryptic
            blockchain addresses (ex. 0xfa91d23…) into simple human-readable addresses (ex.
            myname.etc).
          </Card>
          <Card className="green" to="https:/docs.etcdevteam.com/" title="Emerald Platform">
            Emerald Platform is an ETC tool chain to enable developers and power users to more
            easily use the ETC network. In time these tools will make ETC and other Ethereum-based
          ...
          <Card className="orange" to=" https://www.youtube.com/watch?v=gtsWHXSSiiE" title="Orbita">
            ETCDEV’s answer to ETC-based sidechains, powered by SputnikVM and highly flexible to
            cater to the business needs of developers interested in blockchain.
          </Card>
          <Card
            className="orange"
          ...
          <Card className="orange" to="http://connext.network/#eth" title="Connext">
            Connext is a layer 2 micropayment network that enables EVM compatible projects to
            process cheap, fast and low latency transactions by deploying state channels to scale
            their P2P applications. They also maintain the LearnChannels.org knowledge base.
          </Card>
          ...
          <Card className="orange" to="https://utrust.com/" title="UTRUST">
            A cryptocurrency payment solution that accepts ETC and offers instant transactions,
            buyer protection & crypto-to-cash settlements.
          </Card>
          ...
          <Card className="red" to="http://pikamoji.com/" title="Pikamoji">
            ...
            emojis. A first in the Cryptocurrency space. Ownership is recorded on the ETC
            blockchain.
          </Card>
        </Grid>
      </WideSection>
