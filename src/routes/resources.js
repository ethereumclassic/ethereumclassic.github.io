...
const Reseources = ({ pageContext: { i18n } }) => {
  return (
    <>
      ...
      <Cards columns={'50% 50%'}>
          <Card title="Github Repos">
            <LinkGroup
              items={[
                { text: "ETC (general)", link: "https://github.com/ethereumclassic/" },
                { text: "IOHK", link: "https://github.com/input-output-hk/mantis" },
                { text: "ETC Cooperative", link: "https://github.com/ethereum-classic-cooperative/" },
                { text: "ETCDEV", link: "https://github.com/ETCDEVTeam/" },
                { text: "Ethereum Commonwealth", link: "https://github.com/EthereumCommonwealth/" },
              ]}
            />
          </Card>
          <Card title="Twitter">
            <LinkGroup
              items={[
                { text: "@Eth_Classic", link: "http://twitter.com/Eth_Classic" },
                { text: "@ClassicIsComing", link: "https://twitter.com/ClassicIsComing" },
                { text: "@ETCDEV", link: "https://twitter.com/etcdev" },
                { text: "@ETCCooperative", link: "https://twitter.com/ETCCooperative" },
                ...
                { text: "@ETC_Philippines", link: "https://twitter.com/ETC_Philippines" },
              ]}
            />
          </Card>
          <Card title="Chat Rooms" span={2}>
            <LinkGroup
              items={[
                ...
                { text: "Matrix (Dev-focused)", link: "https://riot.im/app/#/room/#ecips:matrix.org" },
                { text: "Kakao Talk (Korea)", link: "https://open.kakao.com/o/gi4uNJ1" },
              ]}
            />
            <LinkGroup
              title="Telegram"
              items={[
                ...
                { text: "Eth Classic (English)", link: "http://telegram.me/ethclassic" },
                ...
                { text: "ETC Japan", link: "https://t.me/joinchat/GqAqlRC9hD5bVy65DuHcfg" },
        ...
        <Card title="Nodes & Network Info">
            ...
            <LinkGroup
              title="Nodes"
              items={[
                { text: "Geth", link: "https://github.com/ethereumclassic/go-ethereum/" },
                { text: "Parity", link: "https://github.com/paritytech/parity/releases" },
                { text: "Mantis", link: "https://github.com/input-output-hk/mantis" },
                { text: "Multi-Geth", link: "https://github.com/ethoxy/multi-geth/releases" },
              ]}
            />
            <LinkGroup
              title="Network Info"
              items={[
                ...
                { text: "ETC Network Stats (Saturn Tools)", link: "https://saturn.tools/admin/etcstats" },
                { text: "Morden (Testnet) Stats", link: "http://mordenstats.ethertrack.io/" },
              ]}
            />
          </Card>
          <Card title="Public APIs">
            Query ETC without syncing a node. Please note these are public nodes and are intended for testing and light use. Please run your own nodes for your programs. JSONRPC API references can be found for parity and geth-etc.
            <LinkGroup
              items={[
                { text: "ethereumclassic.network", link: "https://ethereumclassic.network" },
                { text: "kotti.ethereumclassic.network", link: "https://kotti.ethereumclassic.network" },
                { text: "web3.gastracker.io", link: "https://web3.gastracker.io" },
              ]}
            />
          </Card>
          </Cards>
        ...
        <Cards columns={'50% 50%'}>
          <Card title="Wallets">
            ...
            <LinkGroup
              ...
              items={[
                { text: "Ledger", link: "https://www.ledgerwallet.com/products/12-ledger-nano-s" },
                { text: "iOS", link: "https://itunes.apple.com/us/app/parity-signer/id1218174838" },
                { text: "Android", link: "https://play.google.com/store/apps/details?id=com.nativesigner" },
            ...
            <LinkGroup
              ...
              items={[
                ...
                { text: "Daedalus Mantis", link: "https://github.com/input-output-hk/mantis/releases/tag/v1.1-rc4" },
                { text: "Emerald", link: "https://github.com/ETCDEVTeam/emerald-wallet/releases" },
            ...
            <LinkGroup
              ...
              items={[
                { text: "Atomic Wallet*", link: "https://atomicwallet.io/" },
                { text: "Coinbase Wallet", link: "https://wallet.coinbase.com/" },
            ...
            <LinkGroup
              title="Web"
              items={[
                { text: "Classic Ether Wallet", link: "https://ethereumclassic.github.io/etherwallet/" },
                { text: "Guarda*", link: "https://guarda.co/" },
                { text: "My Ether Wallet", link: "https://www.myetherwallet.com/" },
                { text: "MyCrypto", link: "http://mycrypto.com/" },
                { text: "SATURN Wallet*", link: "https://saturn.network/saturn-wallet" },
              ]}
            />
          </Card>
          ...
          NOTE: No listings here are an endorsement of the quality or reliability of the exchange. Please do your own research before transacting with exchanges.
              ...
              items={[
                ...
                { text: "Bitcoin Meester", link: "https://www.bitcoinmeester.nl/" },
                { text: "BitForex", link: "https://bitforex.com/" },
                { text: "Bithumb", link: "https://www.bithumb.com/" },
                { text: "Bitladon", link: "https://www.bitladon.com/" },
                { text: "Bittrex", link: "https://bittrex.com/Market/Index?MarketName=BTC-ETC" },
                { text: "Bitfinex", link: "https://www.bitfinex.com/" },
                { text: "BitMex", link: "https://www.bitmex.com/app/trade/ETHM18" },
                { text: "BitSane", link: "https://bitsane.com/exchange/etc-btc" },
                ...
                { text: "Changelly", link: "https://changelly.com/exchange/BTC/ETC/1" },
                { text: "ChangeNow", link: "https://changenow.io/?utm_source=etc&utm_medium=ref&utm_campaign=etc_exchanges" },
                { text: "CHBTC", link: "https://trans.chbtc.com/etc" },
                { text: "Circle Invest", link: "https://www.circle.com/en/invest" },
                { text: "Coindirect", link: "https://www.coindirect.com/buy/ethereum-classic" },
                { text: "CoinEgg", link: "https://www.coinegg.com/" },
                { text: "CoinEx", link: "https://www.coinex.com/" },
                { text: "Coinexchange", link: "https://www.coinexchange.io/market/ETC/BTC" },
                ...
                { text: "Poloniex", link: "https://poloniex.com/exchange#btc_etc" },
          ...
          <Card title="Mining Pools">
            ...
            <LinkGroup
              items={[
                ...
                { text: "2miners", link: "https://2miners.com/etc-mining-pool" },
                ...
                { text: "uCrypto.net", link: "https://ucrypto.net/currency/?curr=ETC" },
                { text: "Uleypool", link: "https://uleypool.com/mining-pool-ethereum-classic-etc/" },
          ...
          <Card title="Block Explorers">
            ...
            <LinkGroup
              items={[
                { text: "BlockScout", link: "https://blockscout.com/etc/mainnet/" },
                { text: "BlockScout Github", link: "https://github.com/poanetwork/blockscout" },
                { text: "Gastracker.io", link: "https://gastracker.io/" },
                { text: "Etherhub.io", link: "http://etherhub.io/" },
                { text: "Etherhub Github", link: "https://github.com/ethereumproject/explorer/" },
                { text: "ETCPlanet.org", link: "https://etcplanet.org/" },
                { text: "ETCPlanet Github", link: "https://github.com/cseberino/etcplanet" },
                { text: "MinerGate", link: "https://minergate.com/blockchain/etc/blocks" },
                { text: "0xETH", link: "http://0xeth.com/" },
                { text: "Kotti (Testnet) Explorer", link: "https://kottiexplorer.ethernode.io/" },
                { text: "Morden (Testnet) Explorer", link: "http://mordenexplorer.ethertrack.io/home" },
              ]}
            />
          </Card>
