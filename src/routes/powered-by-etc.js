  ...
  return (
    <>
      ...
      <Grid>
        ...
        <Card className="green" link="https://stampery.com/" title="Stampery">
          Stampery certifies data on the blockchain, providing proof of existence, integrity,
          ownership, and receipt.
        </Card>
        <Card className="green" link="https:/www.portal.network/" title="Portal Network's BNS">
        ...
        <Card className="green" link="https:/docs.etcdevteam.com/" title="Emerald Platform">
        ...
        <Card className="green" link="https://github.com/input-output-hk/mantis" title="Mantis">
          A lightweight, compact, and high performance client for the ETC network, created by IOHK
          and written in Scala.
        </Card>
        <Card className="orange" link=" https://www.youtube.com/watch?v=gtsWHXSSiiE" title="Orbita">
        ...
        <Card className="orange" link="https:/github.com/goerli" title="Goerli">
          A unified PoA testnet that will provides for a reliable and efficient developer
          experience.
        </Card>
        <Card className="green" link="https://dappdirect.net/" title="DappDirect">
        ...
        <Card className="orange" link="http://connext.network/#eth" title="Connext">
        ...
        <Card className="green" link="https://blockscou.com/etc/m" title="BlockScout">
          A full-featured and high-performance ETC block explorer by POA Network.
        </Card>
        <Card className="green" link="https:/www.coingame.com/" title="Coingame">
          A sports betting platform that started on ETC.
        </Card>
        <Card className="green" link="https:/www.saturn.network/" title="Saturn Network">
          A decentralized exchange running on both ETC and ETH.
        </Card>
        <Card className="green" link="https://quiknode.io/" title="QuikNode">
          Quickly spin up ETC and other Ethereum-based nodes.
        </Card>
        <Card className="orange" link="http:/dev.ethernode.io/" title="Ethernode">
          One click ETC node hosting (in beta).
        </Card>
        <Card className="orange" link="https://utrust.com/" title="UTRUST">
        ...
        <Card className="orange" link="https:/sat-1.com/" title="SAT-1">
        ...
        <Card className="red" link="https://metronome.io/" title="Metronome">
          A cross-blockchain cryptocurrency that will start off bridged between ETC and ETH
          blockchains.
        </Card>
        <Card className="red" link="http://pikamoji.com/" title="Pikamoji">
