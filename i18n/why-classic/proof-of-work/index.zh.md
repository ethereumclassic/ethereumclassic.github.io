...
- 坦率地说，使用权益证明的决定可能是出于经济动机，而不是环境问题的给定原因。
...
没有什么比股权证明的神话更能体现集中化的微妙和阴险的本质了。 从表面上看，这是一个高尚的尝试，旨在纠正区块链技术最糟糕的方面，并使其与可持续发展的未来兼容，但仔细观察，这个危险的想法牺牲了技术最自由的品质，以换取不那么高尚的目标。

实际上，权益证明的普及不仅有浪费时间和资源的风险，而且如果它的采用不受挑战，权益证明可能会谴责未来在伪装成中立的捕获系统上运行的证明；加密货币领域的发展并没有促进人类的繁荣，而是以牺牲所有人的开放效用为代价，促进了超级精英不断增长的力量。
...
权益证明区块链不是从系统外部获取安全性，而是通过自我引用自己的状态来确保安全，因此，这些协议载有额外的责任、复杂性和攻击面，这些可能会危及这种安全性的产生方式。

这种安全的自我参照可以被描述为一种打破热力学定律的永动机。 从表面上看，复杂的面纱可能会欺骗观察者，让他们以为它可以长期自我维持，但实际上，一个未被注意到的制约因素意味着它必将在不远的将来陷入停顿。

![权益证明永动机](./overbalance.jpg)
...
可能这类硬币的持有者认为他们正在提供与挖矿相当的服务，但他们并没有像挖矿那样将外部现实世界的支出转化为安全利益。 相反，他们正在，在泰坦尼克号上洗牌，通过通货膨胀向非制造者征税，将价值从网络中的其他地方重新分配给自己。
