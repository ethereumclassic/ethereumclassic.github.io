...
Dado que no hay guardianes, los mecanismos de consenso de la Prueba de Trabajo no pueden preocuparse por de cómo se crea hashrate, o _de quién ha contribuido_ . Se trata de una cualidad esencial para que una cadena se mantenga neutral y no sea capturada, ya que si existieran guardianes, podrían rechazar el trabajo basándose en la identidad o la ubicación de un colaborador, bloqueándolo y, al hacerlo, centralizando y capturando la red.
