...
The question isn't whether a project should have a roadmap, but whether it can feasibly continue to employ one as it becomes increasingly decentralized. Both Ethereum (Classic) and Bitcoin were initially developed with fixed development milestones in mind, but once these projects were brought to life, it became crucial for their creators to relinquish control, allowing them to evolve and flourish autonomously.
